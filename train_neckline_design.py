...
model_dir = "model/neckline_design_design"
logs_dir = "./logs/neckline_design"
label_dir = './Annotations/neckline_design_labels.csv'
print_dir = './logs/logs_neckline_design.txt'
